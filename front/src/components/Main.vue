    ...
    <div>
        ...
        <el-dialog title="提示" :visible.sync="centerDialogVisible" width="30%" center>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="centerDialogVisible = false" style="font-size: 18px;">
                    <i class="iconfont icon-r-left" style="font-size: 22px;"></i>取 消</el-button>
                <el-button type="primary" @click="save" style="font-size: 18px;">
                    <i class="iconfont icon-r-yes" style="font-size: 22px;"></i>确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
